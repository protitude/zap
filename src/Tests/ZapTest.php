...
/**
 * @file
 * Contains \Drupal\Zap\Tests\ZapTest.
 */

namespace Drupal\Zap\Tests;
...
/**
 * Tests Zap installation profile expectations.
 *
 * @group Zap
 */
class ZapTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'zap';
  ...
  /**
   * Tests Zap installation profile.
   */
  function testZap() {
    $this->drupalGet('');
    ...
    // Zap profile modules are enabled.
    ...
    // Ensure that configuration from the Zap profile is not reused when
